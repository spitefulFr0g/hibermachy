...
const files = {
  [path.join(root, "plugin/manifest.json")]: JSON.stringify({ schemaVersion: 1, id: "dev.hibermachy", kinds: ["service", "panel"], entryPoints: { service: "Service.qml", panel: "Panel.qml" } }),
